...
public class InternalMiniExprLexer extends Lexer {
    ...
    public final void mT__18() throws RecognitionException {
        try {
            int _type = T__18;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMiniExpr.g:17:7: ( '>=' )
            // InternalMiniExpr.g:17:9: '>='
            {
            match(">="); 
    ...
    public final void mT__30() throws RecognitionException {
        try {
            int _type = T__30;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMiniExpr.g:29:7: ( 'true' )
            // InternalMiniExpr.g:29:9: 'true'
            {
            match("true"); 
    ...
    public final void mT__31() throws RecognitionException {
        try {
            int _type = T__31;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMiniExpr.g:30:7: ( 'false' )
            // InternalMiniExpr.g:30:9: 'false'
            {
            match("false"); 
    ...
    public final void mT__36() throws RecognitionException {
        try {
            int _type = T__36;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMiniExpr.g:35:7: ( '|' )
            // InternalMiniExpr.g:35:9: '|'
            {
            match('|'); 
    ...
    public final void mRULE_NUMBER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMiniExpr.g:1382:13: ( RULE_INT ( '.' ( RULE_INT )? )? )
            // InternalMiniExpr.g:1382:15: RULE_INT ( '.' ( RULE_INT )? )?
            {
            mRULE_INT(); 
            // InternalMiniExpr.g:1382:24: ( '.' ( RULE_INT )? )?
            int alt2=2;
            ...
            switch (alt2) {
                case 1 :
                    // InternalMiniExpr.g:1382:25: '.' ( RULE_INT )?
                    {
                    match('.'); 
                    // InternalMiniExpr.g:1382:29: ( RULE_INT )?
                    int alt1=2;
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMiniExpr.g:1384:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalMiniExpr.g:1384:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalMiniExpr.g:1384:11: ( '^' )?
            int alt3=2;
            ...
            // InternalMiniExpr.g:1384:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop4:
            do {
                int alt4=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            // InternalMiniExpr.g:1386:19: ( ( '0' .. '9' )+ )
            // InternalMiniExpr.g:1386:21: ( '0' .. '9' )+
            {
            // InternalMiniExpr.g:1386:21: ( '0' .. '9' )+
            int cnt5=0;
            loop5:
            do {
                ...
                switch (alt5) {
            	case 1 :
            	    // InternalMiniExpr.g:1386:22: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMiniExpr.g:1388:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalMiniExpr.g:1388:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalMiniExpr.g:1388:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt8=2;
            ...
            switch (alt8) {
                case 1 :
                    // InternalMiniExpr.g:1388:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalMiniExpr.g:1388:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop6:
                    do {
                        int alt6=3;
                    ...
                    break;
                case 2 :
                    // InternalMiniExpr.g:1388:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalMiniExpr.g:1388:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop7:
                    do {
                        int alt7=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMiniExpr.g:1390:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalMiniExpr.g:1390:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalMiniExpr.g:1390:24: ( options {greedy=false; } : . )*
            loop9:
            do {
                int alt9=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMiniExpr.g:1392:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalMiniExpr.g:1392:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalMiniExpr.g:1392:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop10:
            do {
                int alt10=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMiniExpr.g:1394:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalMiniExpr.g:1394:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalMiniExpr.g:1394:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt13=0;
            loop13:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalMiniExpr.g:1396:16: ( . )
            // InternalMiniExpr.g:1396:18: .
            {
            matchAny(); 
    ...
    static final String DFA14_eotS =
        "\3\uffff\1\40\2\34\1\44\1\46\1\50\3\uffff\1\56\3\uffff\2\63\5\uffff\1\34\1\uffff\2\34\27\uffff\1\63\1\uffff\1\63\7\uffff\2\63\1\100\1\63\1\uffff\1\102\1\uffff";
    static final String DFA14_eofS =
        "\103\uffff";
    static final String DFA14_minS =
        "\1\0\2\uffff\1\174\1\46\4\75\3\uffff\1\52\3\uffff\1\162\1\141\5\uffff\1\101\1\uffff\2\0\27\uffff\1\165\1\uffff\1\154\7\uffff\1\145\1\163\1\60\1\145\1\uffff\1\60\1\uffff";
    static final String DFA14_maxS =
        "\1\uffff\2\uffff\1\174\1\46\4\75\3\uffff\1\57\3\uffff\1\162\1\141\5\uffff\1\172\1\uffff\2\uffff\27\uffff\1\165\1\uffff\1\154\7\uffff\1\145\1\163\1\172\1\145\1\uffff\1\172\1\uffff";
    static final String DFA14_acceptS =
        "\1\uffff\1\1\1\2\6\uffff\1\13\1\14\1\15\1\uffff\1\17\1\20\1\21\2\uffff\1\25\1\26\1\27\1\30\1\32\1\uffff\1\33\2\uffff\1\37\1\40\1\1\1\2\1\3\1\31\1\4\1\5\1\6\1\22\1\7\1\11\1\10\1\12\1\13\1\14\1\15\1\35\1\36\1\16\1\17\1\20\1\21\1\uffff\1\33\1\uffff\1\25\1\26\1\27\1\30\1\32\1\34\1\37\4\uffff\1\23\1\uffff\1\24";
    static final String DFA14_specialS =
        "\1\2\30\uffff\1\0\1\1\50\uffff}>";
    static final String[] DFA14_transitionS = {
            "\11\34\2\33\2\34\1\33\22\34\1\33\1\6\1\31\2\34\1\15\1\4\1\32\1\16\1\17\1\13\1\11\1\23\1\12\1\25\1\14\12\26\1\2\1\34\1\10\1\5\1\7\1\1\1\34\32\30\1\22\1\34\1\24\1\27\1\30\1\34\5\30\1\21\15\30\1\20\6\30\1\34\1\3\uff83\34",
            "",
            "",
            "\1\37",
            "\1\41",
