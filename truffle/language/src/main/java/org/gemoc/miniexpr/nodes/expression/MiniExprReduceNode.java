...
public abstract class MiniExprReduceNode extends MiniExprExpressionNode {
	...
	protected MiniExprReduceNode(MiniExprExpressionNode left, MiniExprExpressionNode right) {
		this.thenNode = left;
		this.elseNode = right;
	}
